...
const Searchbar = (p) => {
  ...
  return (
    <div className={'flex h-10 md:m-auto md:w-1/2 max-md:w-full border-4 border-current rounded-lg  bg-blue-50 text-blue-50 ' + p.className}>
      <input className='w-full text-gray-500 rounded-l-md indent-4 bg-blue-50 focus:outline-white' type="text" name="search" placeholder='search products ...'/>
