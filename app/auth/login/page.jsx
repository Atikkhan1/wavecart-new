                    ...
                    <div className="w-full flex-1 ">
                        ...
                        <form>
                            ...
                            <div className='flex items-center my-2 ml-2'>
                                <input type="checkbox" onClick={(e)=>{e.currentTarget.checked? setshow("text"):setshow('password')}} id="show" name="show" />
                            ...
                            <h1 className='flex justify-center text-xl italic' >or</h1>

                            <Link href="/auth/signup"
                                className="mt-2 border-2 border-green-400  tracking-wide font-semibold text-green-400 text-white-500 w-full py-4 rounded-lg hover:bg-gray-300 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                <svg className="w-6 h-6 -ml-2 mr-2" fill="none" stroke="currentColor" strokeWidth="2"
                                    strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" />
                                    <circle cx="8.5" cy="7" r="4" />
